	...
	function library:Window(WindowName)
		...
		Main.BackgroundColor3 = _G.Theme.MainColor
		...
		Underline.BackgroundColor3 = _G.Theme.UnderlineColor
		...
		WindowTitle.TextColor3 = _G.Theme.TitleColor
		...
		Container.ImageColor3 = _G.Theme.SecondaryColor
		...
		ToggleImage.ImageColor3 = _G.Theme.CloseUIColor
		...
		GetToggle.MouseButton1Click:Connect(function()
			Enabled = not Enabled
			local Color = Enabled and _G.Theme.OpenUIColor or _G.Theme.CloseUIColor
		...
		function UI:Toggle(name,callback)
			...
			ToggleImage.ZIndex = 6
			ToggleImage.Image = "rbxassetid://3570695787"
			ToggleImage.ImageColor3 = _G.Theme.ToggleBackGround
			ToggleImage.ScaleType = Enum.ScaleType.Slice
			ToggleImage.SliceCenter = Rect.new(100, 100, 100, 100)
			...
			ToggleSlideButton.ImageColor3 = _G.Theme.ToggleOffColor
			...
			ToggleTitle.TextColor3 = _G.Theme.TextColor
			...
			Toggle.MouseButton1Click:Connect(function()
				Enabled = not Enabled
				callback(Enabled)
				local Color = Enabled and _G.Theme.ToggleOnColor or _G.Theme.ToggleOffColor
		...
		function UI:Slider(name,min,max,callback)
			...
			SliderHolder.BackgroundColor3 = _G.Theme.SecondaryColor
			...
			SliderTItle.TextColor3 = _G.Theme.TextColor
			SliderTItle.TextSize = 18.000

			SliderLine.Name = "SliderLine"
			SliderLine.Parent = SliderHolder
			SliderLine.BackgroundColor3 = _G.Theme.SliderLineColor
			...
			SliderImage.ImageColor3 = _G.Theme.SliderColor
			...
			SliderNumbers.Text = ""
			SliderNumbers.TextColor3 = _G.Theme.TextColor
		...
		function UI:Button(name,callback)
			...
			ButtonHolder.BackgroundColor3 = _G.Theme.ButtonColor
			...
			Button.BackgroundColor3 = _G.Theme.ButtonColor
			...
			Button.TextColor3 = _G.Theme.TextColor
		...
		function UI:Dropdown(name,Object,callback)
			...
			HolderDrop.BackgroundColor3 = _G.Theme.DropDownColor
			...
			ToggleHolder.BackgroundColor3 = _G.Theme.DropDownColor
			ToggleHolder.BorderSizePixel = 0
			...
			ToggleDropdown.Text = "<"
			ToggleDropdown.TextColor3 = _G.Theme.DropDownArrow
			...
			DropdownInput.TextColor3 = _G.Theme.TextColor
			...
			for i,v in pairs(Object) do
				...
				Button.BackgroundColor3 = _G.Theme.Drop
				Button.BorderColor3 = _G.Theme.DropDownBoarder
				Button.Position = UDim2.new(0.852380931, 0, 0, 0)
				Button.Size = UDim2.new(0, 188, 0, 25)
				Button.ZIndex = 8
				Button.Text = v
				Button.Font = Enum.Font.SourceSansSemibold
				Button.TextColor3 = _G.Theme.DropDownTextColor
		...
		function UI:ColorPicker(name,default,callback)
			...
			ColorTitle.TextColor3 = _G.Theme.TextColor
			...
			OpenColorPicker.ImageColor3 = _G.Theme.ColorPickerColor
		...
		function UI:Box(name,callback)
			...
			BoxTitle.Text = name
			BoxTitle.TextColor3 = _G.Theme.TextColor
			...
			Box.BackgroundColor3 = _G.Theme.BoxColor
			...
			Box.Text = ""
			Box.TextColor3 = _G.Theme.BoxTextColor
			Box.TextSize = 14.000
		...
		function UI:Bind(name, default, callback)
			...
			KeyBindTitle.TextColor3 = _G.Theme.TextColor
			...
			KeyButton.BackgroundColor3 = _G.Theme.BindColor
			...
			KeyButton.Text = ". . ."
			KeyButton.TextColor3 = _G.Theme.BindTextColor
